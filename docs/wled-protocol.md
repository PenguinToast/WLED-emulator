...
- `GET|POST /api/emulator/audio`: latest normalized audio state, including volume bands, beat/BPM, major peak frequency, and 16 analyzer bins. This endpoint remains as an HTTP fallback and inspection endpoint.
